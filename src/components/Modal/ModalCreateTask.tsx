...
import { FaClipboard, FaExclamation, FaRegistered, FaTimes } from "react-icons/fa";
...
const createTaskSchema = yup.object().shape({
    ...
    description: yup.string().required("Campo obrigatório").max(100, 'Maximo de 100 caracteres'),
})

export const ModalCreateTask = ({ isOpen, onClose}: ModalCreateTaskProps) => {

    const {
        formState: {errors}, register, handleSubmit} = useForm<TaskData>({
    ...
    return (
       <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalHeader display="flex"> 
            ...
            <Center onClick={onClose} as="button" ml="auto" w="32px" h="32px" bg="red.600" fontSize="lg" borderRadius="md">
          ...
          <ModalFooter flexDirection='column'>
            <Button type="submit" bg="purple.500" color="white" w='100%' h="50px"  _hover={{bg: "purple.600"}}>
              Adicionar Tarefa
            </Button>
          </ModalFooter>
        </ModalContent>
